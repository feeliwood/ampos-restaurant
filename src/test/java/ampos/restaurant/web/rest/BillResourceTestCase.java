...
public class BillResourceTestCase extends BaseTestCase {
    ...
    public void getBillTestCase() throws IOException, Exception {
        ...
        MenuItemDTO expectedResult = new MenuItemDTO( (long) 1,
                "Chicken Tom Yum Pizza", "All-time favourite toppings, Hawaiian pizza in Tropical Hawaii style.",
    ...
    public void createBillItemTestCase() throws IOException, Exception {
        ...
        // compare
        MvcResult result = mockMvc.perform( post( "/bills/1/bill-items" )
    ...
    public void updateBillItemTestCase() throws IOException, Exception {
        ...
        MvcResult result = mockMvc.perform( put( "/bills/1/bill-items/1" )
                .contentType( MimeTypeUtils.APPLICATION_JSON_VALUE ).content( "2" ) )
