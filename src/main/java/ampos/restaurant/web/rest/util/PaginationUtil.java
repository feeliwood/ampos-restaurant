...
public final class PaginationUtil {
    ...
    public static HttpHeaders generatePaginationHttpHeaders(int page, int size, int totalPages, String baseUrl) {
	HttpHeaders headers = new HttpHeaders();
	headers.add("X-Total-Count", Long.toString(totalPages));
	String link = "";
